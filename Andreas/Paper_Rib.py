...
em = emc.EMode(simulation_name = 'Paper_Rib') # custom file name instead of the default "emode.eph"
...
em.shape(name = 'cladding', material = 'PDMS', height = 1000)
em.shape(name = 'core', material = 'Parylene_C', height = 400,
